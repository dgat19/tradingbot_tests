 ...
 */
export declare const browserWindowSessionIntegration: (options?: Options | undefined) => import("@sentry/types").Integration;
//# sourceMappingURL=browser-window-session.d.ts.map