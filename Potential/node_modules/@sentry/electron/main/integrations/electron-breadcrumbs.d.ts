 ...
 */
export declare const electronBreadcrumbsIntegration: (userOptions?: Partial<ElectronBreadcrumbsOptions<EventTypes>> | undefined) => import("@sentry/types").Integration;
export {};
